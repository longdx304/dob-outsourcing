	...
	return (
		...
		>
			{data.map((item: any) => (
				<div
					key={item.key}
					className="relative flex flex-col justify-end relative desktop:max-w-[500px] desktop:h-[400px] mobile:max-w-[380px] mobile:h-[220px] overflow-hidden rounded-lg
